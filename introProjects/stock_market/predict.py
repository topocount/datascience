...
avg_365 = mkt['Close'].rolling(365).mean().shift(1)
avg_5 = mkt['Close'].rolling(5).mean().shift(1)
avg_30 = mkt['Close'].rolling(30).mean().shift(1)
std_30 = mkt['Close'].rolling(30).std().shift(1)
